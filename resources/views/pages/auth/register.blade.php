...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow-lg p-3  bg-body-tertiary rounded border-0" style="width: 400px;">
            <h3 class="text-center "><b>Đăng Ký</b></h3>
            <form action="{{ route('register.post') }}" method="POST">
                @csrf
                <div class="mt-3 ">
                    <label for="name" class="form-label"><b>Tên</b></label>
                ...
                <button type="submit" class="mt-3 btn w-100 btn-secondary">Đăng ký</button>
            </form>
