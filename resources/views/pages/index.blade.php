...
@section("contents")
                                ...
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                <h4>Phụ kiện</h4>
                                                <p>Phụ kiện thời trang phù hợp với bạn.</p>
                                                <div class="main-border-button">
                                                    <a href="#">Xem thêm</a>
                                                </div>
                                            </div>
    ...
    @foreach($categories as $category)
        @if($category->hotProducts->isNotEmpty())
            <section class="section" id="men">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="section-heading">
                                <h2>Thời trang {{ $category->name  }} đang hot</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="men-item-carousel">
                                <div class="owl-men-item owl-carousel">
                                    @foreach($category->hotProducts as $product)
                                        <div class="item">
                                            <div class="thumb">
                                                <div class="hover-content">
                                                    <ul>
